...
```{r, warning=FALSE}
emp_df <- read.csv("Employment - National - Daily.csv")

emp_df$date <- as.Date(with(emp_df, paste(year, month, day,sep="-")), "%Y-%m-%d")
...
ggplot() +
  ...
  annotate("text", x=as.Date("2020-09-22"), y=-0.15,
           ...
           color="purple",
           size=3) +
  annotate("text", x=as.Date("2020-10-15"), y=0.03,
           label= "0% \n (0.1m)",
           color="turquoise",
           size=3) +
  annotate("text", x=as.Date("2020-10-15"), y=-0.01,
           label= "-2% \n (0.5m)",
           color="darkblue",
           size=3) +
  annotate("text", x=as.Date("2020-10-15"), y=-0.045,
           label= "-8% \n (2.4m)",
           color="orange",
           size=3) +
  annotate("text", x=as.Date("2020-10-15"), y=-0.17,
           label= "-20% \n (6.3m)",
           color="purple",
           size=3) +
